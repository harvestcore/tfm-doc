...
1. [Crear un bot.](https://github.com/harvestcore/matroos/issues/1)
...
5. [Crear un comando.](https://github.com/harvestcore/matroos/issues/5)
...
9. [Desplegar bot.](https://github.com/harvestcore/matroos/issues/9)
10. [Cancelar despliegue de bot.](https://github.com/harvestcore/matroos/issues/10)
11. [Consultar estado de los despliegues.](https://github.com/harvestcore/matroos/issues/11)
12. [Interfaz gráfica](https://github.com/harvestcore/matroos/issues/25)
...
| Sección                | Contenido                                                    |
| ---------------------- | ------------------------------------------------------------ |
| Resumen                | Como usuario administrador quiero crear bots de Discord en el sistema para poder configurarlos con los comandos que yo quiera para que éstos realicen las tareas que deseo. |
| Meta                   | Creación de bots para que más tarde puedan ser configurados y desplegados. |
| Perfil de usuario      | Usuario con conocimientos avanzados en:<br />- Configuración de Discord.<br />- Administración de sistemas.<br />- Despliegue de software y sistemas. |
...
| Notas técnicas         | Elementos necesarios para la creación del bot:<br />- key: str [req]. Key del bot, proporcionada en el panel de control de Discord.<br />- name: str [req]. Nombre del bot.<br /><br />Parámetros extra necesarios para crear un bot:<br />- id: UUID [req]. Identificador único para cada bot. |
| Dependencias           | –                                                            |
...
| Sección                | Contenido                                                    |
| ---------------------- | ------------------------------------------------------------ |
| Resumen                | Como usuario administrador quiero consultar los detalles de los bots de Discord creados en el sistema. |
| Meta                   | Obtener todos los datos de un bot en concreto o de todos los bots creados en el sistema. |
| Perfil de usuario      | Usuario con conocimientos avanzados en:<br />- Configuración de Discord.<br />- Administración de sistemas.<br />- Despliegue de software y sistemas. |
| Escenario              | - Dado: que quiero consultar los detalles de los bots creados en el sistema,<br />- Cuando: hago una petición al sistema para ello,<br />- Entonces: el sistema me devuelve los datos de los bots. |
...
| Notas técnicas         | Parámetros necesarios para obtener los detalles de un bot específico:<br />- id: UUID [req]. Identificador único para cada bot. |
| Dependencias           | –                                                            |
| Tareas de seguimiento  | –                                                            |
...
| Sección                | Contenido                                                    |
| ---------------------- | ------------------------------------------------------------ |
| Resumen                | Como usuario administrador quiero poder editar los detalles de un bot de Discord. |
...
| Notas técnicas         | Parámetros necesarios para obtener los detalles de un bot específico y para modificarlo:<br />- id: UUID [req]. Identificador único para cada bot.<br />- key: str. Key del bot, proporcionada en el panel de control de Discord.<br />- name: str. Nombre del bot.<br />- command_id: UUID. Identificador único para cada comando. |
| Dependencias           | - Crear un bot.<br />- Crear un comando.                     |
| Tareas de seguimiento  | –                                                            |
...
| Notas técnicas         | Parámetros necesarios para eliminar un bot:<br />- id: UUID [req]. Identificador único para cada bot. |
| Dependencias           | - Crear un bot.                                              |
| Tareas de seguimiento  | –                                                            |
...
| Sección                | Contenido                                                    |
| ---------------------- | ------------------------------------------------------------ |
| Resumen                | Como usuario administrador quiero crear comandos para los bots de Discord para que éstos realicen las tareas que deseo. |
| Meta                   | Creación de comandos que posteriormente puedan ser asignados a bots. |
| Perfil de usuario      | Usuario con conocimientos avanzados en:<br />- Configuración de Discord.<br />- Administración de sistemas.<br />- Despliegue de software y sistemas. |
...
| Notas técnicas         | Parámetros necesarios para obtener los detalles de un comando específico:<br />- id: UUID [req]. Identificador único para cada comando. |
| Dependencias           | - Crear un comando.                                          |
| Tareas de seguimiento  | –                                                            |
...
| Sección                | Contenido                                                    |
| ---------------------- | ------------------------------------------------------------ |
| Resumen                | Como usuario administrador quiero poder editar los detalles de un comando. |
| Meta                   | Permitir la edición de los parámetros de los comandos (nombre, prefijo, parámetros, etc). |
| Perfil de usuario      | Usuario con conocimientos avanzados en:<br />- Configuración de Discord.<br />- Administración de sistemas.<br />- Despliegue de software y sistemas. |
...
| Notas técnicas         | Parámetros necesarios para obtener los detalles de un bot específico y para modificarlo:<br />- id: UUID [req]. Identificador único para cada bot.<br />- prefix: str. Prefijo del comando.<br />- params: dict. Parámetros adicionales del comando. |
| Dependencias           | - Crear un comando.                                          |
| Tareas de seguimiento  | –                                                            |
...
| Sección                | Contenido                                                    |
| ---------------------- | ------------------------------------------------------------ |
| Resumen                | Como usuario administrador quiero poder eliminar un comando. |
| Meta                   | Permitir el borrado de comandos.                             |
| Perfil de usuario      | Usuario con conocimientos avanzados en:<br />- Configuración de Discord.<br />- Administración de sistemas.<br />- Despliegue de software y sistemas. |
...
| Sección                | Contenido                                                    |
| ---------------------- | ------------------------------------------------------------ |
| Resumen                | Como usuario administrador quiero poder desplegar los bots de Discord que he creado y configurado previamente en el sistema. |
| Meta                   | Desplegar bots en los workers para que puedan usarse desde los servidores de Discord. |
| Perfil de usuario      | Usuario con conocimientos avanzados en:<br />- Configuración de Discord.<br />- Administración de sistemas.<br />- Despliegue de software y sistemas. |
| Escenario              | - Dado: que quiero desplegar un bot de Discord,<br />- Cuando: proveo al sistema de un identificador de bot de Discord existente,<br />- Entonces: el sistema despliega el bot automáticamente. |
...
| Notas técnicas         | Elementos necesarios para el despliegue del bot:<br />- id: UUID [req]. Identificador único para cada bot. |
| Dependencias           | - Crear un bot.<br />- Editar un bot.<br />- Crear un comando.<br />- Editar un comando. |
| Tareas de seguimiento  | –                                                            |
...
| Sección                | Contenido                                                    |
| ---------------------- | ------------------------------------------------------------ |
| Resumen                | Como usuario administrador quiero cancelar el despliegue de un bot de Discord en el sistema. |
| Meta                   | Cancelar el despliegue de bots en los workers para que dejen de poder usarse desde los servidores de Discord. |
| Perfil de usuario      | Usuario con conocimientos avanzados en:<br />- Configuración de Discord.<br />- Administración de sistemas.<br />- Despliegue de software y sistemas. |
| Escenario              | - Dado: que quiero cancelar el despliegue de un bot,<br />- Cuando: proveo al sistema de un identificador de bot de Discord que se encuentre desplegado,<br />- Entonces: el sistema cancela el despliegue del bot. |
| Notas funcionales      | - No se debe permitir cancelar el despliegue de un bot que no se encuentra desplegado. |
| Notas técnicas         | Parámetros necesarios para cancelar el despliegue de un bot:<br />- id: UUID [req]. Identificador único para cada bot. |
| Dependencias           | - Crear un bot.<br />- Editar un bot.<br />- Crear un comando.<br />- Editar un comando.<br />- Desplegar un bot. |
| Tareas de seguimiento  | –                                                            |
...
| Notas técnicas         | Datos a devolver:<br />- []workers: []Worker, [req]. Todos los workers que hay disponibles en el sistema.<br /><br />Worker:<br />- id: UUID [req]. Identificador único para cada worker.<br />- uptime: DateTime. El tiempo de actividad del worker.<br />- location: str. La URL donde se encuentra el worker.<br />- []bots: []Bot. Los bots que están desplegados en el worker.<br /><br />Bot:<br />- id: UUID [req]. Identificador único para cada bot.<br />- uptime: DateTime. El tiempo de actividad del bot.<br />- ... |
| Dependencias           | - Crear un bot.<br />- Editar un bot.<br />- Crear un comando.<br />- Editar un comando.<br />- Desplegar un bot.<br />- Cancelar el despliegue de un bot. |
| Tareas de seguimiento  | –                                                            |
...
| Sección                | Contenido                                                    |
| ---------------------- | ------------------------------------------------------------ |
| Resumen                | Como usuario administrador quiero disponer de una interfaz gráfica para poder crear, configurar, desplegar y conocer el estado de los bots de Discord. |
...
| Perfil de usuario      | Usuario con conocimientos avanzados en:<br />- Configuración de Discord.<br />- Administración de sistemas.<br />- Despliegue de software y sistemas. |
| Escenario              | - Dado: que quiero administrar los bots de Discord,<br />- Cuando: accedo a la interfaz gráfica,<br />- Entonces: el sistema me permite realizar todas las tareas de administración de bots. |
| Notas funcionales      | –                                                            |
| Notas técnicas         | –                                                            |
| Dependencias           | - Crear un bot.<br />- Consultar datos de un bot.<br />- Editar un bot.<br />- Eliminar un bot.<br />- Crear un comando.<br />- Consultar datos de un comando.<br />- Editar un comando.<br />- Eliminar un comando.<br />- Desplegar un bot.<br />- Cancelar el despliegue de un bot.<br />- Consultar estado de los despliegues. |
| Tareas de seguimiento  | –                                                            |
